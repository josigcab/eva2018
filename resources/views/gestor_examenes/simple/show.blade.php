...
<!--Comienza path para VER Respuestas a preguntas de seleccion multiples.
    ...
    -->
    <h1 style="padding-top: 20px;">Respuesta {{ $simple->id }}</h1>
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                         ...
                         <a href="{{ url('/gestor_examenes/simple/' . $simple->id . '/'.$id_examen.'/delete') }}" class="btn btn-danger btn-xs" title="Eliminar Multiple" onclick="return myfuncion()"><span class="glyphicon glyphicon-trash" aria-hidden="true" title="Eliminar Multiple" /></a>
                    </td>
                </tr>
            </tfoot>
        </table>
