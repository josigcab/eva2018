    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <a href="{{ url('/gestor_examenes/examen/' . $examan->id . '/update/'.$id_curso.'/edit') }}" class="btn btn-primary btn-xs" title="Editar Examen"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
