        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($examen as $item)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/gestor_examenes/examen/'. $item->id .'/ver/'.$id_curso.'/materia') }}" class="btn btn-success btn-xs" title="Ver Examen"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>

                        <a href="{{ url('/gestor_examenes/examen/' . $item->id . '/update/'.$id_curso.'/edit') }}" class="btn btn-primary btn-xs" title="Editar Examen"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
