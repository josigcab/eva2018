    ...
    {{-- */$id_user=Auth::id();   
             ...
             @if ($name_rol=="estudiante")
               ...
               <!--Comienza path de contenido del curso desde estudiante.
                ...
                <div class="col-md-14 col-md-offset-0 borderpath" style="width: 34%;margin-left: 0%;">
                    ...
                    <li><a href="{{ url('admin/curso/index_todo/todo')}}"><i class="fa fa-dashboard"></i>Cursos</a></li>
        ...
        <div class="col-md-14 col-md-offset-0" style="padding-top:50px;">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Contenido del Curso</div>
      ...
      <!-- Main content -->
       {{-- */$curso= DB::table('cursos')->where('id', $id_curso)->first();
             ...
             /* --}}
      <div class="row">
         <div style=" width: 70%; float :right; text-align: center;padding-right: 8%; font-size: 200%;"><h1><strong>{{$titulo}}</strong></h1></div>
         </br>
         </br>
         </br>
         </br>
       <div style="width: 70%; float :right; text-align: center;padding-right: 8%;font-size: 100%; color: ;"><h3>{{$descripcion}}</h3></div>
         ...
         <!-- <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Compose</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-header with-border">
              <h3 class="box-title" style="color: gray">Informacion General</h3>
             <div class="box-tools">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
               ...
               <li class="dropdown">
                  ...
                  <li><a href="{{url('gestor_examenes/examen/'.$id_curso.'/listar_estudiantes')}}">Estudiantes inscritos</a></li>
