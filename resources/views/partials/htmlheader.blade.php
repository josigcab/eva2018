<head>
    ...
    <link href="{{ asset('/css/skins/skin-green-light-min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('/css/qualityPasswd.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('/css/calidadPasswd.css') }}" rel="stylesheet" type="text/css" />
