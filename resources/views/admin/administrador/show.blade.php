    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover">
            <tbody>
                ...
                <tr><th> Nombre </th><td> {{ $administrador->name }} </td></tr><tr><th> {{ trans('administrador.apellido') }} </th><td> {{ $administrador->apellido }} </td></tr><tr><th> {{ trans('administrador.direccion') }} </th><td> {{ $administrador->direccion }} </td></tr>{{ trans('administrador.email') }} </th><td> {{ $administrador->email }} </td></tr>
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="2">
