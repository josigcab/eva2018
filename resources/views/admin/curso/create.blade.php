...
<div class="container">
    ...
    <div class="col-md-14 col-md-offset-0 borderpath" style="width: 28%;margin-left: 0%;">
                    <ol class="breadcrumb">
                    <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i>Gestor de Cursos</a></li>
                    <li><a href="#"></i>Crear Nuevo curso</a></li>
                    </ol>
        </div>
    ...
    -->
        <div class="col-md-14 col-md-offset-0" style="padding-top:50px;">
            <div class="panel panel-default">
                <div class="panel-heading">GESTOR DE CURSO</div>
...
<div class="container">
    ...
    {!! Form::open(['url' => '/admin/curso', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('descripcion') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::textarea('descripcion', null, ['class' => 'form-control', null]) !!}
                    {!! $errors->first('descripcion', '<p class="help-block">:message</p>') !!}
                </div>
            </div>


            <li style="text-align: center; color: red;"></i>Este sera contraseña para inscribirse al curso</a></li>
            <div class="form-group {{ $errors->has('codigo') ? 'has-error' : ''}}">
                {!! Form::label('codigo', 'Contraseña', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
